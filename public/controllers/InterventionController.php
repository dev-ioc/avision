...
class InterventionController
{
     ...
     * déjà sélectionnés (narrowing mutuel des filtres interventions)
     */
    ...
    public function get_all_sites()
    {
        ...
        try {
            ...
            custom_log("Erreur get_all_sites (interventions) : " . $e->getMessage(), 'ERROR');
            http_response_code(500);
    ...
    public function get_all_buildings()
    {
        ...
        try {
            ...
            custom_log("Erreur get_all_buildings (interventions) : " . $e->getMessage(), 'ERROR');
            http_response_code(500);
    ...
    public function get_all_rooms()
    {
        ...
        try {
            ...
            custom_log("Erreur get_all_rooms (interventions) : " . $e->getMessage(), 'ERROR');
            http_response_code(500);
