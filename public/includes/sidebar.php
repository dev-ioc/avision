  ...
  <ul class="menu-inner py-1">
    ...
    <?php if (isStaff()): ?>
      ...
      <li class="menu-item <?php echo $isContractPage ? 'active open' : ''; ?>">
        ...
        <ul class="menu-sub">
          <li
            class="menu-item <?php echo ($isContractListPage || $isContractViewPage || $isContractEditPage) ? 'active' : ''; ?>">
            <a href="<?php echo BASE_URL; ?>contracts" class="menu-link">
              <div data-i18n="contracts_list">Liste des contrats</div>
            </a>
          </li>
          <li
            class="menu-item <?php echo (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], '/hors_contrat_facturable') !== false) ? 'active' : ''; ?>">
          ...
          <li
            class="menu-item <?php echo (isset($_SERVER['REQUEST_URI']) && strpos($_SERVER['REQUEST_URI'], '/hors_contrat_non_facturable') !== false) ? 'active' : ''; ?>">
      ...
      <li class="menu-item  <?php echo isActivePage('avance'); ?></li>">
        <a href="https://avance-vdsc.vercel.app/" class="menu-link" target="_blank" rel="noopener noreferrer">
          <img src="<?php echo BASE_URL; ?>assets/img/Avance.png" class="menu-icon avance-logo" alt="Avance">
    ...
    <li class="menu-item mt-auto">
      <div class="menu-link d-flex align-items-center justify-content-center px-3 py-2">
        <span class="badge bg-warning text-dark">
          <i class="bi bi-code-slash me-1"></i>Version dev 0.9.5
        </span>
      </div>
    </li>
