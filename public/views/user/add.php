...
<div class="d-flex bd-highlight mb-3">
    <div class="p-2 bd-highlight"><h4 class="py-4 mb-6">Nouvel utilisateur</h4></div>
            ...
            <form method="POST" class="needs-validation" novalidate>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <div id="client-section" class="mb-3" style="display: none;">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    typeSelect.addEventListener('change', function() {
        toggleUserSections('type', {
            coefficientSection: 'coef-section',
            adminCheckbox: 'is_admin',
            clientSection: 'client-section',
            permissionsSection: 'permissions-section',
    ...
    clientSelect.addEventListener('change', function() {
        if (this.value && typeSelect.value === 'client') {
            loadClientLocationsSimple(this.value, 'locations-content');
    ...
    // Appliquer les sections initiales
    toggleUserSections('type', {
        coefficientSection: 'coef-section',
        adminCheckbox: 'is_admin',
        clientSection: 'client-section',
    ...
    // Correction : forcer le filtrage des permissions si un type est déjà sélectionné
    if (typeSelect.value) {
        toggleUserSections('type', {
            coefficientSection: 'coef-section',
            adminCheckbox: 'is_admin',
