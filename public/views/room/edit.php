...
// Assurez-vous que $room, $site['client_id'] et $room['building_id'] (pour open_site_id) sont disponibles
    ...
    <div class="d-flex bd-highlight mb-3">
        ...
        <div class="ms-auto p-2 bd-highlight">
            ...
            <?php if ($isAdmin ?? false): ?>
                <a href="<?= BASE_URL ?>room/delete/<?= $room['id'] ?>" class="btn btn-danger"
                        ...
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="comment" name="comment"
                                    rows="3"><?= htmlspecialchars($room['comment'] ?? '') ?></textarea>
                            </div>
                        </div>
                    </div>
