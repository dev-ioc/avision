        ...
        <div class="card border-0 shadow-sm h-100">
          <div class="card-body">
            ...
            <div class="mb-3">
              ...
              <div class="input-group">
                <input type="password" class="form-control" name="new_password" minlength="8" id="new_password">
                <button class="btn btn-outline-secondary" type="button"
    ...
    <div class="modal-content">
      <div class="modal-header border-0 pb-0">
        <div class="w-100 text-center">
          <div
            class="mx-auto mb-2 d-flex align-items-center justify-content-center rounded-circle bg-danger bg-opacity-10"
