...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex bd-highlight mb-3">
        <div class="p-2 bd-highlight">
            <h4 class="py-4 mb-6">Détails du matériel</h4>
        </div>
        ...
        <div class="ms-auto p-2 bd-highlight">
            ...
            <?php if (canDeleteDocumentation()): ?>
                    <button type="button" class="btn btn-outline-danger btn-sm"
                        onclick="confirmDeleteMateriel(<?= $materiel['id'] ?>, '<?= htmlspecialchars($materiel['marque'] ?? '') ?> <?= htmlspecialchars($materiel['modele'] ?? '') ?>')"
    ...
    <?php if ($materiel): ?>
            <?php
            // Sécuriser toutes les clés optionnelles pour éviter les warnings
            $materiel = array_merge([
                'url_github' => null,
                'ip_primaire' => null,
                'mac_primaire' => null,
                'ip_secondaire' => null,
                'mac_secondaire' => null,
                'stream_aes67_recu' => null,
                'stream_aes67_transmis' => null,
                'ssid' => null,
                'type_cryptage' => null,
                'password_wifi' => null,
                'libelle_pa_salle' => null,
                'numero_port_switch' => null,
                'vlan' => null,
                'id_materiel' => null,
                'usage_materiel' => null,
                'reference' => null,
                'ancien_firmware' => null,
                'login' => null,
                'password' => null,
                'commentaire' => null,
                'date_fin_maintenance' => null,
                'date_fin_garantie' => null,
                'date_derniere_inter' => null,
                'updated_at' => null,
                'type_materiel' => null,
                'numero_serie' => null,
                                                ...
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    <span class="text-muted">
                                                        ...
                                                        <?php if (isset($visibilites_champs[$materiel['id']]['type_materiel']) && !$visibilites_champs[$materiel['id']]['type_materiel']): ?>
                                                                <i class="<?php echo getIcon('visibility_hidden', 'bi bi-eye-slash'); ?> text-warning ms-1"
                                                                    title="Masqué aux clients"></i>
                                                        <?php endif; ?>
                                                    </span>
                                                    <span
                                                        class="fw-medium"><?= $materiel['type_materiel'] ? htmlspecialchars($materiel['type_materiel']) : '-' ?></span>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['reference'] ? htmlspecialchars($materiel['reference']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['usage_materiel'] ? htmlspecialchars($materiel['usage_materiel']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['numero_serie'] ? htmlspecialchars($materiel['numero_serie']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['adresse_mac'] ? htmlspecialchars($materiel['adresse_mac']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['adresse_ip'] ? htmlspecialchars($materiel['adresse_ip']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['masque'] ? htmlspecialchars($materiel['masque']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['passerelle'] ? htmlspecialchars($materiel['passerelle']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['id_materiel'] ? htmlspecialchars($materiel['id_materiel']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['login'] ? htmlspecialchars($materiel['login']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <div class="input-group" style="width: 200px;">
                                                        <input type="password" class="form-control form-control-sm"
                                                            id="password"
                                                            value="<?= $materiel['password'] ? htmlspecialchars($materiel['password']) : '' ?>"
                                                            readonly>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3 pt-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['version_firmware'] ? htmlspecialchars($materiel['version_firmware']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['ancien_firmware'] ? htmlspecialchars($materiel['ancien_firmware']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span class="fw-medium">
                                                        <?php if (!empty($materiel['url_github'] ?? null)): ?>
                                                                <a href="<?= h($materiel['url_github']) ?>" target="_blank"
                                                                    class="text-primary">
                                        ...
                                        <div class="row border-bottom pb-3 mb-3 pt-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['ip_primaire'] ? htmlspecialchars($materiel['ip_primaire']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['mac_primaire'] ? htmlspecialchars($materiel['mac_primaire']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['ip_secondaire'] ? htmlspecialchars($materiel['ip_secondaire']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['mac_secondaire'] ? htmlspecialchars($materiel['mac_secondaire']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-0">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['stream_aes67_recu'] ? htmlspecialchars($materiel['stream_aes67_recu']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['stream_aes67_transmis'] ? htmlspecialchars($materiel['stream_aes67_transmis']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3 pt-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['ssid'] ? htmlspecialchars($materiel['ssid']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['type_cryptage'] ? htmlspecialchars($materiel['type_cryptage']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <div class="input-group" style="width: 200px;">
                                                        <input type="password" class="form-control form-control-sm"
                                                            id="passwordWifi"
                                                            value="<?= $materiel['password_wifi'] ? htmlspecialchars($materiel['password_wifi']) : '' ?>"
                                                            readonly>
                                                        <button class="btn btn-outline-secondary btn-sm" type="button"
                                                            id="togglePasswordWifi"
                                                            title="Afficher/Masquer le mot de passe WiFi">
                                        ...
                                        <div class="row border-bottom pb-3 mb-3 pt-3">
                                            <div class="col-md-6 border-end pe-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['libelle_pa_salle'] ? htmlspecialchars($materiel['libelle_pa_salle']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['numero_port_switch'] ? htmlspecialchars($materiel['numero_port_switch']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= $materiel['vlan'] ? htmlspecialchars($materiel['vlan']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= !empty($materiel['date_fin_maintenance']) && $materiel['date_fin_maintenance'] !== '0000-00-00' && strpos($materiel['date_fin_maintenance'], '0000-00-00') !== 0 ? formatDateFrench($materiel['date_fin_maintenance']) : '-' ?></span>
                                                </div>
                                            </div>
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= !empty($materiel['date_fin_garantie']) && $materiel['date_fin_garantie'] !== '0000-00-00' && strpos($materiel['date_fin_garantie'], '0000-00-00') !== 0 ? formatDateFrench($materiel['date_fin_garantie']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row border-bottom pb-3 mb-3">
                                            <div class="col-md-6 ps-3">
                                                <div class="d-flex justify-content-between align-items-center mb-2">
                                                    ...
                                                    <span
                                                        class="fw-medium"><?= !empty($materiel['date_derniere_inter']) && $materiel['date_derniere_inter'] !== '0000-00-00' && strpos($materiel['date_derniere_inter'], '0000-00-00') !== 0 ? formatDateFrench($materiel['date_derniere_inter']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-12">
                                                <div class="d-flex justify-content-between align-items-start mb-2">
                                                    ...
                                                    <span class="fw-medium text-end"
                                                        style="max-width: 60%;"><?= $materiel['commentaire'] ? htmlspecialchars($materiel['commentaire']) : '-' ?></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    <div class="card-header py-1 d-flex justify-content-between align-items-center">
                                                        ...
                                                        <div>
                                                            ...
                                                            <a href="<?php echo BASE_URL; ?>materiel/toggleAttachmentVisibility/<?php echo $materiel['id']; ?>/<?php echo $attachment['id']; ?>"
                                                                ...
                                                                <i
                                                                    class="<?php echo isset($attachment['masque_client']) && $attachment['masque_client'] == 1 ? 'bi bi-eye' : 'bi bi-eye-slash'; ?>"></i>
                                                            </a>
                                                    ...
                                                    <div class="card-body py-2">
                                                        <div class="d-flex align-items-center">
                                                            <?php if (isset($attachment['masque_client']) && $attachment['masque_client'] == 1): ?>
                                                                    <i class="<?php echo getIcon('visibility_hidden', 'bi bi-eye-slash'); ?> text-warning me-2"
                                                                        title="Masqué aux clients"></i>
                                                            <?php endif; ?>
                                                            <?php echo h($attachment['nom_fichier']); ?>
                                                            <?php if ($attachment['commentaire']): ?>
                                                                    <small
                                                                        class="text-muted ms-2">(<?php echo h($attachment['commentaire']); ?>)</small>
                                                            <?php endif; ?>
                                                        </div>
                                                    </div>
                                                </div>
    ...
    <div class="modal fade" id="addAttachmentModal" tabindex="-1" aria-labelledby="addAttachmentModalLabel"
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <form action="<?php echo BASE_URL; ?>materiel/addMultipleAttachments/<?php echo $materiel['id']; ?>"
    ...
    <script src="<?php echo BASE_URL; ?>assets/js/pages/materiel.js"
        onerror="console.error('ERREUR: materiel.js n\'a pas pu être chargé. Vérifiez que le fichier existe et est accessible.');"></script>
