            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <dl class="row mb-0">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['marque']) && !$visibilites_champs[$materiel['id']]['marque']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['modele']) && !$visibilites_champs[$materiel['id']]['modele']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['type_materiel']) && !$visibilites_champs[$materiel['id']]['type_materiel']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['reference']) && !$visibilites_champs[$materiel['id']]['reference']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['usage_materiel']) && !$visibilites_champs[$materiel['id']]['usage_materiel']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['numero_serie']) && !$visibilites_champs[$materiel['id']]['numero_serie']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['version_firmware']) && !$visibilites_champs[$materiel['id']]['version_firmware']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['ancien_firmware']) && !$visibilites_champs[$materiel['id']]['ancien_firmware']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['login']) && !$visibilites_champs[$materiel['id']]['login']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['password']) && !$visibilites_champs[$materiel['id']]['password']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['adresse_ip']) && !$visibilites_champs[$materiel['id']]['adresse_ip']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['adresse_mac']) && !$visibilites_champs[$materiel['id']]['adresse_mac']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['masque']) && !$visibilites_champs[$materiel['id']]['masque']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['passerelle']) && !$visibilites_champs[$materiel['id']]['passerelle']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['id_materiel']) && !$visibilites_champs[$materiel['id']]['id_materiel']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['date_fin_maintenance']) && !$visibilites_champs[$materiel['id']]['date_fin_maintenance']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['date_fin_garantie']) && !$visibilites_champs[$materiel['id']]['date_fin_garantie']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['date_derniere_inter']) && !$visibilites_champs[$materiel['id']]['date_derniere_inter']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['commentaire']) && !$visibilites_champs[$materiel['id']]['commentaire']) ? 'bg-warning bg-opacity-25' : '' ?>">
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <dl class="row mb-0">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['ip_primaire']) && !$visibilites_champs[$materiel['id']]['ip_primaire']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['mac_primaire']) && !$visibilites_champs[$materiel['id']]['mac_primaire']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['ip_secondaire']) && !$visibilites_champs[$materiel['id']]['ip_secondaire']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['mac_secondaire']) && !$visibilites_champs[$materiel['id']]['mac_secondaire']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['stream_aes67_recu']) && !$visibilites_champs[$materiel['id']]['stream_aes67_recu']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['stream_aes67_transmis']) && !$visibilites_champs[$materiel['id']]['stream_aes67_transmis']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['ssid']) && !$visibilites_champs[$materiel['id']]['ssid']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['type_cryptage']) && !$visibilites_champs[$materiel['id']]['type_cryptage']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['password_wifi']) && !$visibilites_champs[$materiel['id']]['password_wifi']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['libelle_pa_salle']) && !$visibilites_champs[$materiel['id']]['libelle_pa_salle']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['numero_port_switch']) && !$visibilites_champs[$materiel['id']]['numero_port_switch']) ? 'bg-warning bg-opacity-25' : '' ?>">
                        ...
                        <dd
                            class="col-sm-8 <?= (isset($visibilites_champs[$materiel['id']]['vlan']) && !$visibilites_champs[$materiel['id']]['vlan']) ? 'bg-warning bg-opacity-25' : '' ?>">
                                    ...
                                    <div class="d-flex justify-content-between align-items-start">
                                        <div class="flex-grow-1">
                                            <div class="d-flex align-items-center mb-1">
                                                <i
                                                    class="<?php echo getIcon('attachment', 'bi bi-paperclip'); ?> me-2 text-muted"></i>
