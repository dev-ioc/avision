          ...
          <div class="px-3 pb-2">
            ...
            <div class="app-calendar-events-filter text-heading">
              <?php if (isset($technicians) && !empty($technicians)): ?>
                <?php foreach ($technicians as $technician): ?>
                  <div class="form-check mb-3">
                    <input class="form-check-input input-filter" type="checkbox"
                      id="select-technician-<?= $technician['id'] ?>" data-value="technician_<?= $technician['id'] ?>"
                      data-technician-id="<?= $technician['id'] ?>" checked />
                ...
                <?php endforeach; ?>
              <?php else: ?>
                <div class="text-muted mb-3">Aucun technicien avec interventions planifiées</div>
              <?php endif; ?>

              <div class="form-check form-check-warning mb-3">
                <input class="form-check-input input-filter" type="checkbox" id="select-sans-affectation"
                  data-value="sans_affectation" checked />
...
<script>
  ...
  // Définir les techniciens pour les filtres JS
