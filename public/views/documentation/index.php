            ...
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h4 class="fw-bold mb-1">
                        ...
                        <span class="text-danger ms-2">en cours de construction</span>
                    </h4>
                    <p class="text-muted mb-0">Gestion et consultation de la documentation par site et salle</p>
                </div>
    ...
    <?php if (empty($filters['client_id'])): ?>
        ...
        <div class="card">
            <div class="card-body text-center py-5">
                ...
                <p class="text-muted mb-3">Choisissez un client dans le filtre ci-dessus pour afficher la documentation associée.</p>
