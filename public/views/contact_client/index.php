                ...
                <div class="card-header py-2">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <div>
                            ...
                            <?php endif; ?>
                            <a href="<?= BASE_URL ?>contactClient/add<?= isset($_GET['site_id']) ? '?site_id=' . $_GET['site_id'] : '' ?><?= isset($_GET['room_id']) ? '&room_id=' . $_GET['room_id'] : '' ?>"
                                ...
                                <tbody>
                                    <?php foreach ($contacts as $contact): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= htmlspecialchars($contact['fonction'] ?? 'Non renseignée') ?>
                                            </td>
                                            <td>
