...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <style>
        @media (max-width: 768px) {
            ...
            .d-flex.gap-2 .btn { font-size: 0.875rem; padding: 0.375rem 0.75rem; }
        }
    </style>
                                ...
                                <script>
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        function validateType() {
                                            if (typeInput.value === '') {
                                                typeError.classList.remove('d-none'); typeInput.classList.add('is-invalid'); return false;
                                            } else {
                                                typeError.classList.add('d-none'); typeInput.classList.remove('is-invalid'); return true;
                                            }
                                        }
                                        validateType();
                                        typeInput.addEventListener('change', validateType);
                                        form.addEventListener('submit', function (e) { if (!validateType()) e.preventDefault(); });
                                    });
                                </script>
                            </div>
                                    ...
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        function validateContract() {
                                            if (contractInput.value === '') {
                                                contractError.classList.remove('d-none'); contractInput.classList.add('is-invalid'); return false;
                                            } else {
                                                contractError.classList.add('d-none'); contractInput.classList.remove('is-invalid'); return true;
                                            }
                                        }
                                        validateContract();
                                        contractInput.addEventListener('change', validateContract);
                                        form.addEventListener('submit', function (e) { if (!validateContract()) e.preventDefault(); });
                                    });
                                </script>
                            </div>
                                    ...
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        function validation() {
                                            if (statutInput.value.trim() === '') {
                                                statutError.classList.remove('d-none'); statutInput.classList.add('is-invalid'); return false;
                                            } else {
                                                statutError.classList.add('d-none'); statutInput.classList.remove('is-invalid'); return true;
                                            }
                                        }
                                        validation();
                                        statutInput.addEventListener('input', function () {
                                            if (statutInput.value.trim() === '') {
                                                statutError.classList.remove('d-none'); statutInput.classList.add('is-invalid');
                                            } else {
                                                statutError.classList.add('d-none'); statutInput.classList.remove('is-invalid');
                                            }
                                        });
                                        form.addEventListener('submit', function (e) { if (!validation()) e.preventDefault(); });
                                    });
                                </script>
                            </div>
                                    ...
                                    document.addEventListener('DOMContentLoaded', function () {
                                        ...
                                        function validation() {
                                            if (prioriInput.value.trim() === '') {
                                                prioriError.classList.remove('d-none'); prioriInput.classList.add('is-invalid'); return false;
                                            } else {
                                                prioriError.classList.add('d-none'); prioriInput.classList.remove('is-invalid'); return true;
                                            }
                                        }
                                        validation();
                                        prioriInput.addEventListener('input', function () {
                                            if (prioriInput.value.trim() === '') {
                                                prioriError.classList.remove('d-none'); prioriInput.classList.add('is-invalid');
                                            } else {
                                                prioriError.classList.add('d-none'); prioriInput.classList.remove('is-invalid');
                                            }
                                        });
                                        form.addEventListener('submit', function (e) { if (!validation()) e.preventDefault(); });
                                    });
...
<!-- ===== STYLES ===== -->
<style>
    .contact-info-card { border-width: 2px !important; border-style: solid !important; box-shadow: 0 2px 8px rgba(0,0,0,0.1) !important; }
    .contact-info-header { border-bottom: 2px solid !important; }
    [data-bs-theme="light"] .contact-info-card { background-color: #f8f9fa !important; border-color: #dee2e6 !important; }
    [data-bs-theme="light"] .contact-info-header { background-color: #e9ecef !important; border-bottom-color: #dee2e6 !important; color: #495057 !important; }
    [data-bs-theme="dark"] .contact-info-card { background-color: var(--bs-body-bg) !important; border-color: var(--bs-border-color) !important; }
    [data-bs-theme="dark"] .contact-info-header { background-color: var(--bs-secondary-bg) !important; border-bottom-color: var(--bs-border-color) !important; color: var(--bs-body-color) !important; }
</style>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadContacts(clientId) {
        ...
        currentContactsRequest = fetch(`${BASE_URL}interventions/getContacts/${clientId}`, { signal: controller.signal })
    ...
    contactClientInput.addEventListener('input', function () { validateEmail(this.value); });
    contactClientInput.addEventListener('blur',  function () { validateEmail(this.value); });
    ...
    document.getElementById('interventionForm').addEventListener('submit', function (e) {
        ...
        if (email && !validateEmail(email)) { e.preventDefault(); contactClientInput.focus(); }
    });
    ...
    function validateWebsiteFormat(website) {
        try { const u = new URL(website); return u.protocol === 'http:' || u.protocol === 'https:'; }
        catch { return false; }
    }
    ...
    document.getElementById('quickCreateClientBtn').addEventListener('click', function () {
        if (!canModifyClients) { alert("Vous n'avez pas les permissions nécessaires pour créer un client."); return; }
    ...
    document.getElementById('saveQuickClientBtn').addEventListener('click', function () {
        ...
        if (email && !validateEmailFormat(email)) { alert("Format d'email invalide"); return; }
        if (website && !validateWebsiteFormat(website)) { alert("Format d'URL invalide"); return; }

        const spinner = document.getElementById('clientSpinner');
        const icon    = document.getElementById('clientIcon');
        const btn     = this;
        spinner.classList.remove('d-none'); icon.classList.add('d-none'); btn.disabled = true;

        fetch(`${BASE_URL}interventions/quickCreateClient`, {
            method: 'POST', headers: { 'X-CSRF-Token': window.csrfToken }, body: formData
        })
            .then(r => r.json())
            .then(data => {
                if (data.success) {
                    const opt = document.createElement('option');
                    opt.value = data.client.id; opt.textContent = data.client.name; opt.selected = true;
            ...
            .finally(() => { spinner.classList.add('d-none'); icon.classList.remove('d-none'); btn.disabled = false; });
    });

    // ── CRUD Site ─────────────────────────────────────────────────────────────

    document.getElementById('quickCreateSiteBtn').addEventListener('click', function () {
        if (!canModifyClients) { alert("Vous n'avez pas les permissions nécessaires pour créer un site."); return; }
        if (!clientSelect.value) { alert("Veuillez d'abord sélectionner un client avant de créer un site."); clientSelect.focus(); return; }
    ...
    document.getElementById('saveQuickSiteBtn').addEventListener('click', function () {
        ...
        if (!clientSelect.value) { alert('Aucun client sélectionné'); return; }
        if (email && !validateEmailFormat(email)) { alert("Format d'email invalide"); return; }
        ...
        fetch(`${BASE_URL}interventions/quickCreateSite`, {
            ...
            .then(data => {
                if (data.success) {
                    const opt = document.createElement('option');
                    opt.value = data.site.id; opt.textContent = data.site.name; opt.selected = true;
    ...
    document.getElementById('quickCreateBuildingBtn').addEventListener('click', function () {
        if (!canModifyClients) { alert("Vous n'avez pas les permissions nécessaires pour créer un bâtiment."); return; }
        if (!siteSelect.value) { alert("Veuillez d'abord sélectionner un site avant de créer un bâtiment."); siteSelect.focus(); return; }
    ...
    document.getElementById('saveQuickBuildingBtn').addEventListener('click', function () {
        ...
        formData.append('client_id', clientSelect.value);
        const name = formData.get('name').trim();
        if (!name) { alert('Le nom du bâtiment est obligatoire'); return; }
        if (!siteSelect.value)   { alert('Aucun site sélectionné'); return; }
        if (!clientSelect.value) { alert('Aucun client sélectionné'); return; }
        ...
        fetch(`${BASE_URL}interventions/quickCreateBuilding`, {
            ...
            .then(data => {
                if (data.success) {
                    const opt = document.createElement('option');
                    opt.value = data.building.id; opt.textContent = data.building.name; opt.selected = true;
    ...
    document.getElementById('quickCreateRoomBtn').addEventListener('click', function () {
        if (!canModifyClients) { alert("Vous n'avez pas les permissions nécessaires pour créer une salle."); return; }
        if (!buildingSelect.value) { alert("Veuillez d'abord sélectionner un bâtiment avant de créer une salle."); buildingSelect.focus(); return; }
    ...
    document.getElementById('saveQuickRoomBtn').addEventListener('click', function () {
        ...
        formData.append('client_id',   clientSelect.value);
        const name = formData.get('name').trim();
        if (!name)                 { alert('Le nom de la salle est obligatoire'); return; }
        if (!buildingSelect.value) { alert('Aucun bâtiment sélectionné'); return; }
        if (!siteSelect.value)     { alert('Aucun site sélectionné'); return; }
        if (!clientSelect.value)   { alert('Aucun client sélectionné'); return; }
        ...
        fetch(`${BASE_URL}interventions/quickCreateRoom`, {
            ...
            .then(data => {
                if (data.success) {
                    const opt = document.createElement('option');
                    opt.value = data.room.id; opt.textContent = data.room.name; opt.selected = true;
    ...
    document.getElementById('quickCreateContactBtn').addEventListener('click', function () {
        if (!canModifyClients) { alert("Vous n'avez pas les permissions nécessaires pour créer un contact."); return; }
        if (!clientSelect.value) { alert("Veuillez d'abord sélectionner un client avant de créer un contact."); clientSelect.focus(); return; }
    ...
    if (flashBtn) {
        flashBtn.addEventListener('click', function () {
            ...
            if (!clientId) { flashClient.classList.add('is-invalid'); flashClient.focus(); return; }
