...
<div class="container-fluid flex-grow-1 container-p-y">
        ...
        <div class="ms-auto p-2 bd-highlight">
            ...
            <?php if ($canModifyClient): ?>
                <a href="<?php echo BASE_URL; ?>clients/edit/<?php echo $client['id'] ?? ''; ?>"
                    class="btn btn-warning me-2" id="editClientBtn">
                    Modifier
                </a>
            <?php else: ?>
    ...
    <?php if ($client): ?>
        ...
        <div class="row g-2 mb-4" id="clientTabs" role="tablist">
            <div class="col">
                <div class="card tab-card active" id="materiel-tab" data-bs-toggle="tab" data-bs-target="#materiel"
                    role="tab" aria-controls="materiel" aria-selected="true"
            ...
            <div class="col">
                <div class="card tab-card" id="interventions-tab" data-bs-toggle="tab" data-bs-target="#interventions"
                    role="tab" aria-controls="interventions" aria-selected="false"
                        ...
                        <?php if (!empty($contacts)): ?>
                            <div class="table-responsive">
                                <table class="table table-striped" id="contactsTable">
                                    <thead>
                                        <tr>
                                            <th class="sortable" data-sort="first_name">Prénom <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="last_name">Nom <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="fonction">Fonction <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="phone1">Téléphone fixe <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="phone2">Mobile <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="email">Email <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                    ...
                    <div class="card-header py-2 d-flex justify-content-between align-items-center">
                        ...
                        <?php if (!empty($sites)): ?>
                            <div class="btn-group" role="group" aria-label="Contrôles accordéon">
                                <button type="button" class="btn btn-sm btn-outline-primary" id="expandAllSites"
                                    title="Déplier tout">
                                    <i class="bi bi-arrows-expand me-1"></i> Déplier tout
                                </button>
                                <button type="button" class="btn btn-sm btn-outline-secondary" id="collapseAllSites"
                                    title="Replier tout">
                                            ...
                                            <div class="accordion-body">
                                                ...
                                                <div class="mt-4">
                                                    <h6 class="fw-bold mb-3"><i
                                                            class="bi bi-building text-warning me-2"></i>Bâtiments et Salles</h6>
                                                                ...
                                                                <div class="card-body py-2">
                                                                    ...
                                                                    <?php else: ?>
                                                                        <div class="alert alert-info mb-0"><i
                                                                                class="bi bi-info-circle me-2"></i> Aucune salle dans ce
                                                                            bâtiment.</div>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                        ...
                        <?php if (!empty($contracts)): ?>
                            <div class="table-responsive">
                                <table class="table table-striped table-hover" id="contractsTable">
                                    <thead>
                                        <tr>
                                            <th class="sortable" data-sort="name">Nom <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="type">Type de contrat <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="end_date">Date de fin <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            ...
                                            <th class="sortable" data-sort="tickets_remaining">Tickets restants <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                            <th class="sortable" data-sort="status">Statut <i
                                                    class="bi bi-arrow-down-up sort-icon"></i></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php foreach ($contracts as $contract): ?>
                                            <tr>
                                                ...
                                                <td data-label="Date de fin"
                                                    data-sort-value="<?php echo strtotime($contract['end_date']); ?>">
                                                    <?php echo formatDateFrench($contract['end_date']); ?>
                                                </td>
                                                <td data-label="Tickets initiaux"
                                                    data-sort-value="<?php echo $contract['tickets_number']; ?>">
                                                ...
                                                <td data-label="Tickets restants"
                                                    data-sort-value="<?php echo $contract['tickets_remaining']; ?>">
                                                    <?php if (isContractTicketById($contract['id'])): ?>
                                                        <span
                                                            class="badge bg-<?php echo $contract['tickets_remaining'] > 3 ? 'success' : 'danger'; ?>">
                                ...
                                <?php foreach ($interventionsGrouped as $contractId => $contractGroup): ?>
                                    <div class="accordion-item">
                                        <h2 class="accordion-header" id="contractHeading<?php echo $contractId; ?>">
                                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse"
                                                ...
                                                <div class="d-flex justify-content-between align-items-center w-100 me-3">
                                                    <span>
                                                        <?php echo h($contractGroup['contract_name']); ?>
                                                    </span>
                                                    <div class="d-flex gap-2">
                                                        <?php if (!empty($contractGroup['preventive'])): ?>
                                                            <span class="badge bg-success">
                                                                <?php echo count($contractGroup['preventive']); ?> préventive(s)
                                                            </span>
                                                        <?php endif; ?>
                                                        <?php if (!empty($contractGroup['corrective'])): ?>
                                                            <span class="badge bg-warning">
                                                                <?php echo count($contractGroup['corrective']); ?> corrective(s)
                                                            </span>
                                                        <?php endif; ?>
                                                    </div>
                                                </div>
                                        ...
                                        <div id="contractCollapse<?php echo $contractId; ?>" class="accordion-collapse collapse"
                                            aria-labelledby="contractHeading<?php echo $contractId; ?>"
                                            data-bs-parent="#interventionsAccordion">
                                            <div class="accordion-body">
                                                <!-- Contenu des interventions existant -->
                                            </div>
                                        </div>
                                    </div>
                                <?php endforeach; ?>
