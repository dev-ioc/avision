...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <?php if ($client): ?>
        ...
        <div class="row g-2 mb-4" id="clientTabs" role="tablist">
            <div class="col">
                <div class="card tab-card active" id="info-tab" data-bs-toggle="tab" data-bs-target="#info" role="tab"
                    aria-controls="info" aria-selected="true" style="cursor: pointer; border: 2px solid #007bff;">
                                                ...
                                                <div class="accordion-item">
                                                    ...
                                                    <div id="siteCollapse<?php echo $site['id']; ?>" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body">
                                                                                    ...
                                                                                    <div class="d-flex">
                                                                                        ...
                                                                                        <div class="flex-grow-1 ms-3">
                                                                                            ...
                                                                                            <?php if (!empty($site['primary_contact']['phone1'])): ?>
                                                                                                    <p class="mb-1 small">
                                                                                                        <i
                                                                                                            class="<?php echo getIcon('phone', 'bi bi-telephone'); ?> me-1"></i>
                                                            ...
                                                            <!-- Bâtiments et Salles du site -->
                                                            <div class="mt-4">
                                                                <h6 class="fw-bold mb-3">
                                                                    <i class="bi bi-building text-warning me-2"></i>Bâtiments et Salles
                                                                </h6>
                                                                                    ...
                                                                                    <div class="card-body py-2">
                                                                                        ...
                                                                                        <?php else: ?>
                                                                                                <div class="alert alert-info mb-0">
                                                                                                    <i class="bi bi-info-circle me-2"></i> Aucune salle dans ce
                                                                                                    bâtiment.
                                                                                                </div>
                                                                                        <?php endif; ?>
                                                                                    </div>
                                                                ...
                                                                <?php else: ?>
                                                                        <div class="alert alert-info">
                                                                            ...
                                                                            <?php if ($canModifyClient): ?>
                                                                                    <a href="<?php echo BASE_URL; ?>building/add/<?php echo $site['id']; ?>?client_id=<?php echo $client['id']; ?>&return_to=view"
                                                                                        class="alert-link">
                                                                                        Ajouter un bâtiment
                                                                                    </a>
                                                                            <?php endif; ?>
                                                            ...
                                                            <div class="d-flex justify-content-between align-items-center w-100 me-3">
                                                                ...
                                                                <div class="d-flex gap-2">
                                                                    <?php if (!empty($contractGroup['preventive'])): ?>
                                                                            <span
                                                                                class="badge bg-success"><?php echo count($contractGroup['preventive']); ?>
                                                                                préventive(s)</span>
                                                                    <?php endif; ?>
                                                                    <?php if (!empty($contractGroup['corrective'])): ?>
                                                                            <span
                                                                                class="badge bg-warning"><?php echo count($contractGroup['corrective']); ?>
                                                                                corrective(s)</span>
                                                                    <?php endif; ?>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div id="contractCollapse<?php echo $contractId; ?>" class="accordion-collapse collapse"
                                                        ...
                                                        <div class="accordion-body">
                                                            ...
                                                            <?php if (!empty($contractGroup['preventive'])): ?>
                                                                    <div class="mb-4">
                                                                        <h6 class="fw-bold text-success mb-3">
                                                                            ...
                                                                            (<?php echo count($contractGroup['preventive']); ?>)
                                                                        </h6>
                                                                        <div class="table-responsive">
                                                                                                ...
                                                                                                <td>
                                                                                                    <small>
                                                                                                        <?php if (($intervention['tickets_used'] ?? 0) > 0): ?>
                                                                                                                <span
                                                                                                                    class="badge bg-info"><?php echo $intervention['tickets_used']; ?></span>
                                                                                                        <?php else: ?>
                                                                                                                <span class="text-muted">-</span>
                                                                                                        <?php endif; ?>
                                                                                                    </small>
                                                            ...
                                                            <?php if (!empty($contractGroup['corrective'])): ?>
                                                                    <div class="mb-4">
                                                                        <h6 class="fw-bold text-warning mb-3">
                                                                            <i class="bi bi-tools me-2"></i>Interventions Correctives
                                                                            (<?php echo count($contractGroup['corrective']); ?>)
                                                                        </h6>
                                                                        <div class="table-responsive">
                                                                            <table class="table table-sm table-striped">
                                                                                <thead>
                                                            ...
                                                            <?php if (empty($contractGroup['preventive']) && empty($contractGroup['corrective'])): ?>
                                                                    <div class="alert alert-info">
                                                                        <i class="bi bi-info-circle me-2"></i> Aucune intervention enregistrée pour ce
                                                                        contrat.
                                                                    </div>
                                                            <?php endif; ?>
                                                        </div>
