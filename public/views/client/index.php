...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex bd-highlight mb-3">
        <div class="p-2 bd-highlight">
            <h4 class="py-4 mb-6">Gestion des Clients</h4>
        </div>
                        ...
                        <tr>
                            <td data-label="Nom du Client">
                                <a href="<?php echo BASE_URL; ?>clients/view/<?php echo $client['id']; ?>"
                                    class="text-decoration-none fw-bold" title="Voir le client">
                            ...
                            <td data-label="Bâtiments" data-order="<?php echo $client['building_count'] ?? 0; ?>">
                                <span class="badge bg-primary">
                                    <?php echo $client['building_count']; ?>
                                </span>
                            </td>
                            ...
                            <td data-label="Tickets Restants"
                                data-order="<?php echo $client['total_tickets_remaining'] ?? 0; ?>">
                                <?php if (($client['total_tickets_remaining'] ?? 0) > 0): ?>
                                    <span
                                        class="badge bg-<?php echo ($client['total_tickets_remaining'] ?? 0) > 10 ? 'success' : 'warning'; ?>">
...
<script>
    ...
    window.serverSavedSettings = {
        clientsTable_pageLength:
            <?= json_encode((int) getUserPreference('datatable_clientsTable_pageLength', 10)) ?>
    };
</script>
