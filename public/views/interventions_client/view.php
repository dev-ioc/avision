...
<div class="container-fluid flex-grow-1 container-p-y">
    ...
    <div class="d-flex bd-highlight mb-3">
        <div class="p-2 bd-highlight">
            <h4 class="py-4 mb-6">Details de l'intervention</h4>
        </div>
    ...
    <?php if ($intervention): ?>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <?php if (!empty($intervention['ref_client'])): ?>
                                <div>
                                    <label class="form-label fw-bold mb-0">Reference client</label>
                                    <p class="form-control-static mb-0"><?= h($intervention['ref_client']) ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
                        ...
                        <div class="d-flex flex-column gap-2">
                           ...
                           <div>
                                ...
                                <p class="form-control-static mb-0">
                                    <?= (int)($intervention['type_requires_travel'] ?? 0) === 1 ? 'Oui' : 'Non' ?>
                                </p>
                            </div>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div>
                                ...
                                <p class="form-control-static mb-0">
                                    <?= date('d/m/Y H:i', strtotime($intervention['created_at'])) ?></p>
                            </div>

                            <!-- Date de cloture (NOUVEAU - point 4 du retour client) -->
                            <?php if (!empty($intervention['closed_at'])): ?>
                                <div>
                                    <label class="form-label fw-bold mb-0">Date de cloture</label>
                                    <p class="form-control-static mb-0">
                                        <?= date('d/m/Y H:i', strtotime($intervention['closed_at'])) ?></p>
                                </div>
                            <?php endif; ?>
                            ...
                            <div>
                                ...
                                <p class="form-control-static mb-0">
                                    <?php if (!empty($intervention['technicians_names'])): ?>
                                        <?= nl2br(htmlspecialchars($intervention['technicians_names'])) ?>
                                    <?php else: ?>
                                        Non attribué
                                    <?php endif; ?>
                                </p>
                    ...
                    <div class="col-md-3">
                        <div class="d-flex flex-column gap-2">
                            ...
                            <div>
                                ...
                                <p class="form-control-static mb-0">
                                    <?= !empty($intervention['planned_date']) ? date('d/m/Y', strtotime($intervention['planned_date'])) : 'Non definie' ?>
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p class="form-control-static mb-0">
                                    <?= !empty($intervention['planned_time']) ? h($intervention['planned_time']) : 'Non definie' ?>
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row mt-4">
            <!-- Section Commentaires + Compte-rendu technicien -->
            <div class="col-md-8">

                <!-- Compte-rendu d'intervention technicien (NOUVEAU - point 3 du retour client) -->
                <?php if (!empty($technicianReports)): ?>
                    <div class="card mb-3">
                        <div class="card-header py-2">
                            <h5 class="card-title mb-0">Compte-rendu d'intervention</h5>
                        </div>
                        <div class="card-body py-2">
                            <?php foreach ($technicianReports as $report): ?>
                                <div class="mb-3 p-3 border rounded">
                                    <div class="d-flex justify-content-between align-items-start mb-2">
                                        <strong><?= h($report['technicien_name'] ?? '') ?></strong>
                                        <small class="text-muted">
                                            <?php if (!empty($report['start_time'])): ?>
                                                <?= date('d/m/Y H:i', strtotime($report['start_time'])) ?>
                                            <?php endif; ?>
                                            <?php if (!empty($report['end_time'])): ?>
                                                &rarr; <?= date('d/m/Y H:i', strtotime($report['end_time'])) ?>
                                            <?php endif; ?>
                                        </small>
                                    </div>
                                    <p class="mb-0"><?= nl2br(h($report['compte_rendu_client'])) ?></p>
                                </div>
                            <?php endforeach; ?>
                        </div>
                    </div>
                                    ...
                                    <div class="modal fade" id="editCommentModal<?= $comment['id'] ?>" tabindex="-1" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                <form action="<?= BASE_URL ?>interventions_client/editComment/<?= $comment['id'] ?>"
                                                    method="post">
                                                    <?= csrf_field() ?>
                                    ...
                                    <div class="card-header py-1 d-flex justify-content-between align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <a href="<?= BASE_URL ?>interventions_client/download/<?= $attachment['id'] ?>"
                                                class="btn btn-sm btn-outline-success btn-action" title="Telecharger"
                                                target="_blank">
        ...
        <div class="modal fade" id="addAttachmentModal" tabindex="-1" aria-labelledby="addAttachmentModalLabel"
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <form action="<?= BASE_URL ?>interventions_client/addMultipleAttachments/<?= $intervention['id']; ?>"
